<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="外键专业ID" prop="majorId">
        <el-input
          v-model="queryParams.majorId"
          placeholder="请输入外键专业ID"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="班级状态" prop="state">
        <el-select v-model="queryParams.state" placeholder="请选择班级状态" clearable size="small">
          <el-option
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="外键专业ID" prop="majorId">
          <el-input v-model="form.majorId" placeholder="请输入外键专业ID" />
        </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        majorId: [
          { required: true, message: "外键专业ID不能为空", trigger: "blur" }
        ],
        createDate: [
